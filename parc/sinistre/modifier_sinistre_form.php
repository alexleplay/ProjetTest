...
<html>
<head>
<title>Modification sinistre</title>
...
echo "<center>";
echo "<span class=style2>- Modification du sinistre N° ".$sinistre." -</span><br><br><br>";
?>
...
<input type="button" value="Retour" onClick="window.location='liste_sinistre.php';">
